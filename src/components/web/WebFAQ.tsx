...
export default function WebFAQ() {
    ...
    return (
        <section className="py-24 relative bg-vibrant-gradient-alt" id="web-faq">
                ...
                <div className="space-y-3">
                    {faqs.map((faq, i) => (
                        <ScrollReveal key={i} delay={i * 0.05}>
                            <div className="rounded-2xl border border-slate-200 dark:border-white/10 bg-white dark:bg-slate-900 overflow-hidden shadow-lg transition-all duration-300 hover:shadow-xl hover:border-brand-blue/30">
                                <button
